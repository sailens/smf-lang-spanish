...
// Traducido por: Sailens

global $settings, $scripturl;

$txt['settings_saved'] = 'Los cambios se han guardado correctamente';
$txt['settings_not_saved'] = 'Tus cambios no se han guardado por el siguiente motivo: %1$s';

$txt['admin_boards'] = 'Boards and Categories';
$txt['admin_users'] = 'Miembros';
$txt['admin_newsletters'] = 'Boletín informativo';
$txt['admin_edit_news'] = 'Noticias';
$txt['admin_groups'] = 'Grupos';
$txt['admin_members'] = 'Gestión de usuarios';
$txt['admin_members_list'] = 'A continuación se encuentran listados todos los miembros registrados en el foro.';
$txt['admin_next'] = 'Siguiente';
$txt['admin_censored_words'] = 'Palabras censuradas';
$txt['admin_censored_where'] = 'Escriba la palabra cesurada a la izquierda, y con qué sustituirla a la derecha.';
$txt['admin_censored_desc'] = 'Dada la naturaleza pública de los foros puede que haya palabras que quieras prohibir mostrar. Introduce cualquier palabra que quieras censurar cuando sea usada por un usuario.<br>Deja la casilla en blanco para eliminar la palabra de la censura.';
$txt['admin_reserved_names'] = 'Nombres reservados';
$txt['admin_template_edit'] = 'Edita el tema del foro';
$txt['admin_modifications'] = 'Ajustes de modificación';
$txt['admin_server_settings'] = 'Ajustes de servidor';
$txt['admin_reserved_set'] = 'Guarda nombres reservados';
$txt['admin_reserved_line'] = 'Una palabra reservada por línea.';
$txt['admin_basic_settings'] = 'Esta página permite cambiar los ajustes básicos del foro. Tenga mucho cuidado con estos ajustes, ya que pueden hacer que el foro no funcione correctamente.';
$txt['admin_maintain'] = 'Activar Modo de mantenimiento';
$txt['admin_title'] = 'Título del foro';
$txt['cookie_name'] = 'nombre de la cookie';
$txt['admin_webmaster_email'] = 'E-mail del Webmaster';
$txt['cachedir'] = 'Carpeta de la caché';
$txt['admin_news'] = 'Activar noticias';
$txt['admin_guest_post'] = 'Permitir a los invitados dejar mensajes';
$txt['admin_manage_members'] = 'Usuarios';
$txt['admin_main'] = 'Principal';
$txt['admin_config'] = 'Configuración';
$txt['admin_version_check'] = 'Control detallado de versión';
$txt['admin_smffile'] = 'Archivo SMF';
$txt['admin_smfpackage'] = 'Paquete SMF';
$txt['admin_logoff'] = 'Cerrar sesión de administrador';
$txt['admin_maintenance'] = 'Mantenimiento';
$txt['admin_image_text'] = 'Muestra los botones como imágenes en lugar de texto';
$txt['admin_credits'] = 'Créditos';
$txt['admin_agreement'] = 'Mostrar y requerir carta de aceptación al registrarse';
...
$txt['admin_agreement_not_saved'] = 'No se han guardado los cambios del acuerdo. Tal vez los permisos de archivo en el archivo no se ajustan correctamente.';
$txt['admin_delete_members'] = 'Eliminar usuarios seleccionados';
$txt['admin_repair'] = 'Reparar todos los foros e hilos';
